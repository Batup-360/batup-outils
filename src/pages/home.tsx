...
const KEYWORDS: Record<string, string> = {
  ...
  '/calculateur-tva': 'tva ht ttc conversion taux calcul calculatrice tva calculer tva ht en ttc prix ht en ttc calcul ht calcul ttc tva 20 tva 10 enlever la tva',
...
const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    description: 'Calculez la TVA : convertissez HT en TTC et TTC en HT en un clic, avec les taux du bâtiment (20, 10, 5,5, 2,1 %).',
    type: 'Calculateur',
    theme: 'Fiscal & légal',
    popularity: 8,
  },
